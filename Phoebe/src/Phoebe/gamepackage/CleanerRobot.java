...
//					System.out.println("Jo lesz a koord"); // kivenni
					...
					// direction.setX(nextPosition.getX() -
					// lastPosition.getX());
					// direction.setY(nextPosition.getY() -
					// lastPosition.getY());
					...
					// Ha le van tiltva a sebesseg modositas, akkor a velo=1
					// legyen
					// mert az elozo elmozdulas-t nem modosithatja
					leng = 50;
